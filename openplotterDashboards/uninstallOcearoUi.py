...
# Copyright (C) 2025 by Sailoog <https://github.com/openplotter/openplotter-dashboards>
#                  
...
def main():
	...
	try:
		...
		subprocess.call(['npm', 'uninstall', '--verbose', 'ocearo-ui', '--save'], cwd = platform2.skDir)
